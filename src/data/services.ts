...
export const serviceCategories: ServiceCategory[] = [
    ...
    documents: [
      {
        ...
        materials: ["学历证书扫描件", "身份证扫描件", "护照扫描件"],
        estimatedFee: 400,
    estimatedDays: 7,
    category: "study",
  },
  ...
  },
  {
    ...
    materials: ["高中毕业证扫描件", "身份证扫描件", "护照扫描件"],
        estimatedFee: 400,
    estimatedDays: 7,
    category: "study",
  },
    ...
    documents: [
      {
        ...
        materials: ["无犯罪记录证明扫描件", "身份证扫描件", "护照扫描件"],
        estimatedFee: 2000,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["驾驶证正副页扫描件", "身份证扫描件", "护照扫描件"],
        estimatedFee: 400,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["出生证明扫描件", "父母身份证扫描件", "申请人护照扫描件"],
        estimatedFee: 2000,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["结婚证扫描件", "夫妻双方身份证扫描件", "护照扫描件"],
        estimatedFee: 2500,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["单身证明扫描件", "身份证扫描件", "户口本扫描件", "护照扫描件"],
        estimatedFee: 1800,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["授权委托书扫描件", "委托人身份证扫描件", "受托人信息"],
        estimatedFee: 1500,
        estimatedDays: 7,
        category: "legal",
      },
      {
        ...
        materials: ["声明书扫描件", "身份证扫描件", "相关辅助材料扫描件"],
        estimatedFee: 1600,
        estimatedDays: 7,
        category: "legal",
      },
